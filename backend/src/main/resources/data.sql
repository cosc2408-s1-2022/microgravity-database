...
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
VALUES (1, true, false,
        'To investigate the relationship between the environment condition and the formation of the agglomerates ',
        null, 'prodelop a single mean field theory for the condesation phenomena of the magnetic particles', null,
...
VALUES (4, true, false,
        ...
        'The cytoskeleton of the Lentil root statocyte', 'Experimental prodelopment', 7, 4, 2, 2);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
VALUES (5, false, false, 'To investigate the enhancements of newly prodeloped hardware', null,
        'Perform space experiments during a short mission life (generally up to 2 weeks)',
        'The Russian Space Agency, Roskosmos', 'University of Brest', 'Highrad', 'Experimental prodelopment', 5, 5, 3,
        16);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
...
VALUES (6, false, false, 'To investigate the relatinship between crystallisation of CdTe and related compounds.', null,
        ...
        'Experimental prodelopment', 2, 6, 3, 4);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
...
VALUES (8, false, false,
        ...
        'Experimental prodelopment', 2, 8, 4, 6);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
...
VALUES (14, false, false,
        ...
        'Experimental prodelopment', 10, 14, 1, 9);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
...
VALUES (16, false, false,
        ...
        'DNAmAGE - Effects of prolonged spaceflight on DNA methylation age', 'Experimental prodelopment', 6, 16, 1, 12);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
VALUES (17, false, false,
        ...
        'BioAsteroid', 'Experimental prodelopment', 6, 17, 1, 12);
INSERT INTO prod.experiment (id, approved, deleted, experiment_aim, experiment_module_drawing, experiment_objective,
                             experiment_publications, lead_institution, title, toa, for_code_id, mission_id,
                             platform_id,
                             seo_code_id)
