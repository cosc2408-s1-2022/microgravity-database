...
import com.rmit.mgdb.service.SEOsService;
 ...
 */
@RestController
@RequestMapping("/api/seos")
public class SEOsController {

    private final SEOsService sEOsService;
     ...
     */
    @Autowired
    public SEOsController(SEOsService sEOsService) {
        this.sEOsService = sEOsService;
    }

    @GetMapping("/all")
    public List<SEOs> getAll() {
        return sEOsService.getAllSEOs();
    }
