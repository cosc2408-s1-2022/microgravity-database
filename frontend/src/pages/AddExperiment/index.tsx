                ...
                <Box sx={{
                    ...
                    >
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                <FormField label='Title' name='title' errors={experimentError?.response?.data}
                                           onChange={setTitle}/>
                            </Grid>
                            <Grid item xs={6}>
                                <FormField label='TOA' name='toa' errors={experimentError?.response?.data}
                                           onChange={setToa}/>
                            </Grid>
                            <Grid item xs={6}>
                                <FormField
                        ...
                        {part.text}
                            ...
                            noOptionsText={
                                <Box display='flex' justifyContent='space-between' alignItems='center'>
                                    ...
                                    <Button variant='outlined' onClick={() => navigate('/addMission')}
